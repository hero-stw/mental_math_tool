...
function Calculation() {
    ...
    answer[0].addEventListener("keyup", function(event) {
        if (event.which >= 65 && event.which <= 255 && event.which != 190) this.value = this.value.slice(0, -1);
        else if (event.which >= 37 && event.which <= 40) return;
        var n = this.value.replace(/,/g, '');
        answer[0].value = new Intl.NumberFormat('en-US', { maximumFractionDigits: 15 }).format(n);
        if (event.keyCode === 190) {
            if (n.indexOf('.') == 0) {
                n.substring(1);
                n = 0;
            } else {
                this.value = n.replace('..', '.');
            }
        }
        if (event.keyCode === 13) {
    ...
    answer[1].addEventListener("keyup", function(event) {
        if (event.which >= 65 && event.which <= 255 && event.which != 190) this.value = 0;
        if (event.which >= 37 && event.which <= 40) return;
        var n = this.value.replace(/,/g, '');
        answer[1].value = new Intl.NumberFormat('en-US', { maximumFractionDigits: 15 }).format(n);
        if (event.keyCode === 190) {
            if (n.indexOf('.') == 0) {
                n.substring(1);
                n = 0;
    ...
    answer[2].addEventListener("keyup", function(event) {
        ...
        if (event.which >= 37 && event.which <= 40) return;
        var n = this.value.replace(/,/g, '');
        answer[2].value = new Intl.NumberFormat('en-US', { maximumFractionDigits: 15 }).format(n);
        if (event.keyCode === 190) {
            if (n.indexOf('.') == 0) {
                n.substring(1);
                n = 0;
    ...
    answer[3].addEventListener("keyup", function(event) {
        ...
        if (event.which >= 37 && event.which <= 40) return;
        var n = this.value.replace(/,/g, '');
        answer[3].value = new Intl.NumberFormat('en-US', { maximumFractionDigits: 15 }).format(n);
        if (event.keyCode === 190) {
            if (n.indexOf('.') == 0) {
                n.substring(1);
                n = 0;
    ...
    answer[4].addEventListener("keyup", function(event) {
        ...
        if (event.which >= 37 && event.which <= 40) return;
        var n = this.value.replace(/,/g, '');
        answer[4].value = new Intl.NumberFormat('en-US', { maximumFractionDigits: 15 }).format(n);
        if (event.keyCode === 190) {
            if (n.indexOf('.') == 0) {
                n.substring(1);
                n = 0;
...
function resetVal() {
    ...
    for (var i = 0; i <= 4; i++) {
        answer[i].value = null;
        answer[i].setAttribute("placeholder", "");
        answer[i].setAttribute("readonly", "true");
        delta[i] = null;
        oprtn[i].innerHTML = "";
